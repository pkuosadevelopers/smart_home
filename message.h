...
/**
 *@brief	delete a message node whose sockfd value matched the given sockfd and so do the ACK value
 *@param	*ack, the ACK data
 *@param	*head, the head pointer of the message nodes list
...
/**
 *@brief	delete all the message node whose sockfd value matched the given sockfd 
 *@param	*head, the head pointer of the message nodes list
 *@param	sockfd, the value that used to find out which node matched a same one
 *@return	the number of message node that have been deleted
 */
